...
public class Product {
	...
	public String toString() {
		return "Product [id=" + id + ", productCategoryId=" + productCategoryId
				+ ", name=" + name + ", tags=" + tags + ", imageUrl="
				+ imageUrl + ", price=" + price + ", stock=" + stock
				+ ", sellNum=" + sellNum + ", viewNum=" + viewNum
				+ ", commentNum=" + commentNum + ", content=" + content
